...
var faceLeft = document.querySelector('.face.left');
var faceRight = document.querySelector('.face.right');
var caution = document.querySelector('.caution');
var lightningLeft = document.querySelector('.face.left img');
var lightningRight = document.querySelector('.face.right img');
var eyebrowLeft = document.querySelector('.eyebrow.left');
var eyebrowRight = document.querySelector('.eyebrow.right');
var mouthChange = document.querySelector('.mouth .bottom');

var eventMouseOver = function eventMouseOver() {
...
var eventMouseOut = function eventMouseOut() {
...
faceLeft.onmouseover = function () {
  eventMouseOver();
};

faceLeft.onmouseout = function () {
  eventMouseOut();
};

faceRight.onmouseover = function () {
  eventMouseOver();
};

faceRight.onmouseout = function () {
  eventMouseOut();
};
...
},{}]},{},["C:/Users/Nestle/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","main.js"], null)
